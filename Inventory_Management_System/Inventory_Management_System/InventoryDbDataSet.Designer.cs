...
namespace Inventory_Management_System {
    ...
    public partial class InventoryDbDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(string ItemCode, string ItemName, string Model, string Company, double Price, int Stock) {
        ...
        public partial class ItemsRow : global::System.Data.DataRow {
            ...
            public string Company {
                get {
                    try {
                        return ((string)(this[this.tableItems.CompanyColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableItems.CompanyColumn] = value;
                }
            }
            ...
            public bool IsCompanyNull() {
                return this.IsNull(this.tableItems.CompanyColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetCompanyNull() {
                this[this.tableItems.CompanyColumn] = global::System.Convert.DBNull;
            }
...
namespace Inventory_Management_System.InventoryDbDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Items] WHERE (([ItemCode] = @Original_ItemCode) AND ((@IsNull_ItemName = 1 AND [ItemName] IS NULL) OR ([ItemName] = @Original_ItemName)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([ItemCode], [ItemName], [Model], [Company], [Price], [" +
                "Stock]) VALUES (@ItemCode, @ItemName, @Model, @Company, @Price, @Stock);\r\nSELECT" +
                " ItemCode, ItemName, Model, Company, Price, Stock FROM Items WHERE (ItemCode = @" +
                "ItemCode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ItemCode] = @ItemCode, [ItemName] = @ItemName, [Model] = @Model, [Company] = @Company, [Price] = @Price, [Stock] = @Stock WHERE (([ItemCode] = @Original_ItemCode) AND ((@IsNull_ItemName = 1 AND [ItemName] IS NULL) OR ([ItemName] = @Original_ItemName)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)));
SELECT ItemCode, ItemName, Model, Company, Price, Stock FROM Items WHERE (ItemCode = @ItemCode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Inventory_Management_System.Properties.Settings.Default.InventoryDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ItemCode, ItemName, Model, Company, Price, Stock FROM dbo.Items";
        ...
        public virtual int Delete(string Original_ItemCode, string Original_ItemName, string Original_Model, string Original_Company, global::System.Nullable<double> Original_Price, global::System.Nullable<int> Original_Stock) {
        ...
        public virtual int Insert(string ItemCode, string ItemName, string Model, string Company, global::System.Nullable<double> Price, global::System.Nullable<int> Stock) {
            if ((ItemCode == null)) {
        ...
        public virtual int Update(string ItemCode, string ItemName, string Model, string Company, global::System.Nullable<double> Price, global::System.Nullable<int> Stock, string Original_ItemCode, string Original_ItemName, string Original_Model, string Original_Company, global::System.Nullable<double> Original_Price, global::System.Nullable<int> Original_Stock) {
            if ((ItemCode == null)) {
                throw new global::System.ArgumentNullException("ItemCode");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemName, string Model, string Company, global::System.Nullable<double> Price, global::System.Nullable<int> Stock, string Original_ItemCode, string Original_ItemName, string Original_Model, string Original_Company, global::System.Nullable<double> Original_Price, global::System.Nullable<int> Original_Stock) {
            return this.Update(Original_ItemCode, ItemName, Model, Company, Price, Stock, Original_ItemCode, Original_ItemName, Original_Model, Original_Company, Original_Price, Original_Stock);
        }
    }
